...
function validate(input){
    let errors = {};
    if(!/^[a-z A-Z]+$/.test(input.userName)||input.userName?.length<3 || input.userName?.length>50){
        errors.userName = "*Campo requerido";
    }
    if(!/^[a-z A-Z]+$/.test(input.firstName)||input.firstName?.length<3 || input.firstName?.length>50){
        errors.firstName = "*Campo requerido, no puede tener números";
    }
    if(!/^[a-z A-Z]+$/.test(input.lastName)||input.lastName?.length<3 || input.lastName?.length>50){
        errors.lastName = "*Campo requerido, no puede tener números";
    }
    if(!/^[0-9]+$/.test(input.userPhone)||input.userPhone?.length<10 || input.userPhone?.length>50){
...
function EditUser  () {
    ...
    function onSubmit(e) {
        e.preventDefault();
        if (!input.userName || !input.firstName || !input.lastName || !input.userEmail || !input.userPhone) {
    ...
    return (
        ...
        <form onSubmit={onSubmit} >
            ...
            <div className="form-container-edit">
                <div>
                    <p className="register-subtitle">(* si realiza cambios en el nombre de usuario y email, deberá iniciar sesión nuevamente!!)</p>
                </div>
                        ...
                        <div className="form-group-one">
                            <div className="labelAndInput">
                                ...
                                <input onChange={(e)=>handlerOnChange(e)}
                                    ...
                                    /> 
                                    {errors.userName && <p className="form-register-errors">{errors.userName}</p>}
                                </div>
                                <div className="labelAndInput">
                                ...
                                <input onChange={(e)=>handlerOnChange(e)}
                                    ...
                                    /> 
                                {errors.firstName && <p className="form-register-errors">{errors.firstName}</p>}
                                </div>
                                <div className="labelAndInput">
                                ...
                                />
                                {errors.userEmail && <p className="form-register-errors">{errors.userEmail}</p>}
                                </div>
                                <div className="labelAndInput">
                                ...
                                />
                                {errors.userPhone && <p className="form-register-errors">{errors.userPhone}</p>}
                                </div>
                                </div>
                                <div>
                                <button
